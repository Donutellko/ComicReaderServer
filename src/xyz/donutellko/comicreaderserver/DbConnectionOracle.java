...
public class DbConnectionOracle {
    ...
    public static void connect() throws ClassNotFoundException, SQLException {
        ...
        conn = DriverManager.getConnection("jdbc:oracle:thin:@oraclebi.avalon.ru:1521:orcl12", "DANSHAF", "danshaf");
    ...
    */
    private static void initialise() throws SQLException {
        ...
        catch (java.sql.SQLSyntaxErrorException e){ e.printStackTrace(); }
...
//		if (!statmt.isClosed()) statmt.close();
    ...
    /*
        Перенёс initDb и closeDb в этот класс, чтобы не засорять main и легче было восстановить прошлую версию
    */
