...
public static void main(String[] args) {
    ...
    // чтобы обновить получить json страниц xkcd (если указан 2)
    // debug = false;
    // parse(ComicDB.getComic(2));
    // String s = new Gson().toJson(ComicDB.getPages(2));
    // System.out.println("\n\n\n\n" + s + "\n\n\n\n\n\n\n");
    // if (true) return;
    //
...
private static <T extends UniversalParser> void savePages(
    ...
    if (page != null && page.this_url != null) nextUrl = getPage(tClass, page.this_url).nextUrl;
