...
public class AcomicsListParser extends UniversalListParser {
	...
	private Comic foobar(String tmp) {
		...
		// TODO: надо выяснить число страниц комикса, сейчас передается 0
		Comic result = new Comic(title, "RU", null, description, init_url, init_url, null, logo_url, "acomics", 0);
		return result;
	}
